...
description: >-
  Use when creating or editing skills, AGENTS.md, CLAUDE.md, or any document
  an agent will consume.
---

Upstream: https://github.com/mattpocock/skills/tree/main/skills/productivity/writing-for-agents  
Last-synced: 2026-09-04  
Copyright: Matt Pocock (MIT). See `LICENSE` in this folder.
